...
%%% with 1991 paper
%
%   [mxy,mz,mxyt,mzt,a,b] = blochsim_CK(B1,G,pos,sens,B0,varargin)
%
...
gamma = 267522.1199722082;        % radians per sec per mT
dt = 6.4e-6;
M0=[0;0;1];
...
Phi = dt*gamma*(abs(bxy).^2+bz.^2).^0.5;
Normfact = dt*gamma*(Phi.^(-1));Normfact(~isfinite(Normfact)) = 0;
