function kTraj = calc_ktraj_from_grad (grad, probeType, isTxBool, dt, method)
...
% probeType: 'H' for proton probe, 'F' for fluorine probe.
%
% Expects
% -------
...
% modified by Jinyuan Zhang, 2025.03.25, add option for different probe types
...
if nargin < 2
  gamma = 2.675e8;           % default, [rad/T] gyromagnetic ratio for proton.
else
    switch probeType
        case 'H'
          gamma = 2.675e8;   % [rad/T] gyromagnetic ratio for proton.
        case 'F'
          gamma = 2.518e8;   % [rad/T] gyromagnetic ratio for fluorine.
        otherwise
