function [fig] = plot_stitch(grad0, triggerDelays, probeType, probeRadius, signalCutoff, nsegs2measure)
%PLOT_STITCH 
%   
    ...
    dt = grad0.dt;
    ktraj    = calc_ktraj_from_grad(grad0.shape(1:2,:) / grad0.gamma, probeType, false, dt);
    ...
    plot(ktraj(1,:), ktraj(2,:)); hold on;
    plot(triggerOnTraj(1,:), triggerOnTraj(2,:), '*', 'MarkerSize', 5);
    axis equal; 
